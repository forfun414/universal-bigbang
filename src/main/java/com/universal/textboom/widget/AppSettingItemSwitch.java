 ...
 */
public class AppSettingItemSwitch extends RelativeLayout {
    ...
    public AppSettingItemSwitch(Context context) {
        this(context, null);
    }

    public AppSettingItemSwitch(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AppSettingItemSwitch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSwitch.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (mOnCheckedChangeListener != null) {
                    compoundButton.setTag(AppSettingItemSwitch.this.getId());
