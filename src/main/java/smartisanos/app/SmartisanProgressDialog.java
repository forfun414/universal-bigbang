...
public class SmartisanProgressDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress = (ProgressBar) view.findViewById(android.R.id.progress);//com.android.internal.R.id.progress
        mMessageView = (TextView) view.findViewById(android.R.id.message);//com.android.internal.R.id.message
        ...
        getWindow().setBackgroundDrawableResource(android.R.color.transparent);//com.android.internal.R.color.transparent
    }
