package com.universal.textboom.widget;
 ...
 */
public class CustomSettingItemSwitch extends RelativeLayout {
    private OnCheckedChangeListener mOnCheckedChangeListener;

    private CustomSwitchEx mSwitch;
    ...
    public CustomSettingItemSwitch(Context context) {
        this(context, null);
    }

    public CustomSettingItemSwitch(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomSettingItemSwitch(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setGravity(Gravity.CENTER_VERTICAL);
        final View container = LayoutInflater.from(context).inflate(
                R.layout.custom_setting_item_switch_layout, this, true);
        ...
        mSwitch = (CustomSwitchEx) container.findViewById(R.id.item_switch);
        ...
        Log.d("SettingItemSwitch", "077777  title " + mTitle.getText());
        ...
        /*setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                LogUtils.d("CustomSettingItemSwitch" , "onClick");
                //isBoomAccServiceEnabled(ctx);
                //ActivityStarter.startAccessibilitySetting(ctx);
            }
        });
        */
        ...
        mSwitch.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (mOnCheckedChangeListener != null) {
                    compoundButton.setTag(CustomSettingItemSwitch.this.getId());
        ...
        mSwitch.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                LogUtils.d("CustomSettingItemSwitch" , "onTouch ");

                if (!hasWindowFocus()) {
                    LogUtils.d("CustomSettingItemSwitch" , "onTouch don't have focus");
                    return true;
                }
                return false;
            }
    ...
    public void setBackgroundResource(int resid) {
        setPadding(0, 0, 0, 0);
        setBackground(getResources().getDrawable(resid));//mContext.getDrawable(resid)
    }
    ...
    public CustomSwitchEx getSwitch() {
        return mSwitch;
    }
