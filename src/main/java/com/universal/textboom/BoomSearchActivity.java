...
public class BoomSearchActivity extends SearchActivity {
    ...
    public static final int TYPE_BAIDU = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_BAIDU;
    public static final int TYPE_GOOGLE = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_GOOGLE;
    public static final int TYPE_BING = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_BING;
    public static final int TYPE_SHENMA = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_SHENMA;
    public static final int TYPE_WIKI = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_WIKI;
    public static final int TYPE_BAIKE = TYPE_WIKI + 1;
    public static final int TYPE_YOUDAO = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_YOUDAO;
    public static final int TYPE_KINGSOFT = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_KINGSOFT;
    public static final int TYPE_BINGDICT = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_BINGDICT;
    public static final int TYPE_HIDICT = Constant.TEXT_BOOM_SEARCH_VALUE.TYPE_HIDICT;
    ...
    protected void onResume() {
        ...
        final int webType = SharedPreferencesManager.getInt(this, Constant.TEXT_BOOM_SEARCH_METHOD, TYPE_SHENMA);
        final int dictType = SharedPreferencesManager.getInt(this, SEARCH_DICT_KEY, TYPE_BINGDICT);
